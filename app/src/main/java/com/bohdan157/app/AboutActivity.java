...
import com.bohdan157.app.databinding.ActivityAboutBinding;
import com.google.android.material.appbar.AppBarLayout;
import com.bohdan157.app.databinding.ActivityAboutContentBinding;
...
public class AboutActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class DownloadStatusTask extends AsyncTask<Void, Long, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (apkFile.exists()) {
                Uri apkUri = FileProvider.getUriForFile(AboutActivity.this, "com.bohdan157.app.fileprovider", apkFile);
    ...
    private void initContent() {
        ...
        mBottomContent.aboutBottomDev.setOnClickListener(this);
    ...
    private void setBottomContentEnabled(boolean enabled) {
        ...
        mBottomContent.aboutBottomDev.setEnabled(enabled);
    ...
    public void onClick(View v) {
        ...
        if (uptimeMillis - mLastClickTime > 600L) {
            ...
            }  else if (v.getId() == mBottomContent.aboutBottomDev.getId()) {
                url = "https://github.com/bohdan157/";
